...
$(function () {
    $("#my-menu").mmenu({
        extensions: ['theme-black', 'fx-menu-slide', 'pagedim-black', 'border-none'],
        navbar: {
    ...
    $(".servises__carousel").owlCarousel({
        loop: true,
        nav: true,
        smartSpeed: 700,
        ...
        onResize: function () {
            carouselHeight($items);
        }
    });

    $(".servises__carousel__item").each(function () {
        var $this = $(this),
            contentHeight = $this.find(".servises__carousel__content").outerHeight();
        $this.find(".servises__carousel__image").css("min-height", contentHeight);


    });

    $(".callback__select").selectize({
        create: true
    });
    ...
    var $items = $(".servises__carousel__item");




    function carouselHeight($items) {
        var max = 0;
        $items.each(function () {
